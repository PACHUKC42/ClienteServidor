 ...
 * @author pachu
 */
public class eReparacion extends javax.swing.JFrame {
...
private boolean verCampo = false;
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBounds(600, 210, 262, 96);
        ...
        jButton1.setBounds(490, 590, 159, 56);
        ...
        jButton2.setBounds(680, 590, 154, 56);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(this.verCampo){
            ...
            conx.conectar();
             int id=Integer.parseInt((String) lista.getSelectedItem());
            Reparacion eliminacion = new Reparacion(id);
            conx.eliminaReparacion(eliminacion);
